...
947 deaths have occurred and 328 patients have been censored (\tabref{tab:cohort}).
...
The overall Kaplan--Meier curve (\figref{fig:km-overall}) falls to about 0.53 at 36 months, most steeply
over the first few months; roughly three quarters of the cohort are alive at one year. Sex
and diabetes do not separate the cohort (\figref{fig:km-sex-dm}): one-year survival is 0.770 against
0.733 by sex and 0.740 against 0.764 by diabetes. Age and discharge BUN, split at their
medians, do (\figref{fig:km-age-bun}): 0.661 above age 76 against 0.844 below, and 0.676 above
...
potassium and \dbun{} (\tabref{tab:pa2cox}; in-sample concordance 0.694). Nine terms are significant:
...
predictions (\figref{fig:cox-aft}) are almost identical to the Cox model's for age, separate slightly
