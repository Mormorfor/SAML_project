...
tails of Figure~5 from the other side: the forest cannot leave the
...
or accuracy by any margin this test set can detect. This follows from Figure~5 --- the models predict alike where
...
version of the discrimination gap in Table~10.
...
thinnest slice of events and is most likely noise. Discharge BUN separated the models most in Figure~5 yet produces no
